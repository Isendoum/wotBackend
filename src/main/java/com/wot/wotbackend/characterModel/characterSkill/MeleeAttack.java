...
public class MeleeAttack extends CharacterSkill {
    ...
    private MeleeAttack(){
        ...
        this.setSkillRank("D");
        this.setSkillDescription("Basic melee attack. Does " +this.getCharacterSkillModifier()*100+"% magic damage to the target. Consumes "+this.getInnerPowerConsume()+"% of inner power to use.");
